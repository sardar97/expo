...
//  private let installer: ExpoRuntimeInstaller

//  public override init(provider: any JavaScriptRuntimeProvider) {
  //    self.installer = ExpoRuntimeInstaller(appContext: T##AppContext, runtime: T##ExpoRuntime)
//  }
